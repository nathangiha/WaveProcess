...
Step #0: Downlaod the latest version of 3.X of Anaconda 
...
pywaves_directory = "C:/Users/Giha/Documents/GetWaveData/"
...
def Using_GetWaveData():
	...
	samples_per_waveform = 500		### Number of samples in a wave (specified in DAFCA)
	...
	Config_File_and_Path = "C:/Users/Giha/Documents/GetWaveData/config.ini"
	...
	time.sleep(1)
	print("\n")
	print("H2DPI_Data[0] ==> The values of each index correspond to 0 how many waves were recorded in that channel.")
	print("H2DPI_Data[1] ==> The values of each index correspond to 1 the pulse integral (V-ns) of each recorded pulse in that channel.")
	print("H2DPI_Data[2] ==> The values of each index correspond to 2 the pulse height (Digitizer Units) of each recorded pulse in that channel.")
	print("H2DPI_Data[3] ==> The values of each index correspond to 3 the tail integral (Digitizer Units-ns) of each recorded pulse in that channel.")
	print("H2DPI_Data[4] ==> The values of each index correspond to 4 the total integral (Digitizer Units-ns) of each recorded pulse in that channel.")
	print("H2DPI_Data[5] ==> The values of each index correspond to 5 the start time (ns) of each recorded pulse in that channel.")
	print("H2DPI_Data[6] ==> The values of each index correspond to 6 the time tag of each recorded pulse in that channel.")
	print("H2DPI_Data[7] ==> The values of each index correspond to 7 the extras of each recorded pulse in that channel.")
	print("H2DPI_Data[8] ==> The values of each index correspond to 8 the absolute start time of each recorded pulse in that channel. Adding this will CFD will give the complete start time of the pulse.")
	print("H2DPI_Data[9] ==> This is an array of zeros. Ignore it.")
	print("H2DPI_Data[10] ==> The values of each index correspond to10the root-mean-squre of the baseline of each pulse.")
	print("\n")
	...
	Integrals_Bar_1 =  H2DPI_Data[1][1]
	...
	Integrals_Bar_1 = H2DPI_Data[1][0][:H2DPI_Counts[0]] + H2DPI_Data[1][1][:H2DPI_Counts[0]]
...
def Running():
	...
	time.sleep(1)
	print("You're not part of the control group, by the way. "+"\n")
	print("You get the gel. Last poor son-of-a-gun got blue paint! "+"\n")
	time.sleep(1)
	print("Hahaha! All joking aside, that did happen. Broke every bone in his legs. Tragic! But informative. "+"\n")
	print("Or so I'm told. We haven't entirley nailed down what element it is yet, but I'll tell you this. "+"\n")
	print("It is a lively one and it does not like the human skeleton. "+"\n")
	time.sleep(2)
	print("Alright, let's actually get started. If you don't get my references throughout this script then I will be sad. User specified steps in this script are denoted by '''"+"\n"+"and say 'Step #N' where N denotes the step number.")
	print("\n")
